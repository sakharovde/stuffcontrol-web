...
describe('StorageTransactionMapper', () => {
  describe('toPersistence', () => {
    it('converts a StorageTransaction to persistence format', () => {
      const storageTransaction = new StorageTransaction('1', 'storage1', 'product1', 10, new Date('2023-01-01'));
  ...
  describe('toDomain', () => {
    it('converts valid data to a StorageTransaction', () => {
      ...
      expect(result).toEqual(new StorageTransaction('1', 'storage1', 'product1', 10, new Date('2023-01-01')));
    });
